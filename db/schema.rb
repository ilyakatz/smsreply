...
ActiveRecord::Schema.define(:version => 20120505043305) do
  ...
  add_index "messages", ["destination", "origin", "received", "direction"], :name => "index_unique_index", :unique => true
  ...
  create_table "user_responder_messages", :force => true do |t|
